...
OWLSAM_OBJECT_CLASSES_STR = "carpet, chair, table, sofa, bed, painting, tv, plant, rug"
...
class OwlSamSegmentor:
    ...
    def get_staged_objects_mask(self, image):
        ...
        instances = self.query(image, texts="carpet, chair, table, sofa, bed, painting, tv, plant, rug")
...
if __name__ == "__main__":
    ...
    staged_objects_mask = owlsam.get_staged_objects_mask(image, "carpet, chair, table, sofa, bed, painting, tv, plant, rug")
    print()
